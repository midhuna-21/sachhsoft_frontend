    ...
    return (
        <section className="flex flex-col items-center p-12 mt-12">
            <div className="w-[90%] text-center">
                ...
                <h2 className="text-3xl font-semibold mt-2 text-customGray py-">
                    Partners who have{" "}
                    <span className="text-white"> thrived with us</span>
                </h2>
            </div>
            <div className="w-[86%] border border-mutedBlueGray rounded-lg mt-12 p-10 relative">
                ...
                <div className="absolute -bottom-5 left-1/2 transform -translate-x-1/2 bg-transparent text-[#C4C7CE] px-6 py-2  text-sm backdrop-blur-sm">
